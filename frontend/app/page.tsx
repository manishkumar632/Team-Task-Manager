    ...
    <div className="flex flex-1 min-h-screen bg-[var(--background)] text-foreground font-sans">
      ...
      <aside className="hidden lg:flex w-64 shrink-0 flex-col gap-2 px-5 py-6 bg-card/60 backdrop-blur border-r border-border/60">
        ...
        <div className="mt-auto flex flex-col gap-2">
          <div className="rounded-3xl p-4 bg-[image:var(--gradient-soft)] border border-border/60">
      ...
      <main className="flex-1 min-w-0 px-6 lg:px-10 py-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_340px] gap-6">
          <div className="flex flex-col gap-6 min-w-0">
            ...
            <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {taskBuckets.map((b) => (
                <div
                  key={b.label}
                  className="rounded-3xl bg-card border border-border/60 p-5 shadow-[var(--shadow-card)] hover:-translate-y-0.5 hover:shadow-[var(--shadow-soft)] transition"
                >
            ...
            {/* Workload curve */}
            <section className="rounded-3xl bg-card border border-border/60 p-6 shadow-[var(--shadow-card)]">
          ...
          <aside className="flex flex-col gap-6">
            <div className="rounded-3xl p-6 bg-[image:var(--gradient-primary)] text-white shadow-[var(--shadow-soft)] relative overflow-hidden">
            ...
            <div className="rounded-3xl bg-card border border-border/60 p-5 shadow-[var(--shadow-card)]">
              <div className="flex items-center justify-between mb-4">
