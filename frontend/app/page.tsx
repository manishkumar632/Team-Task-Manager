    ...
    <div className="flex flex-1 min-h-screen bg-[var(--background)] text-foreground font-sans">
      ...
      <aside className="hidden lg:flex w-64 shrink-0 flex-col gap-2 px-5 py-6 bg-card/60 backdrop-blur border-r border-border/60">
        <div className="flex items-center gap-2 px-2 mb-6">
          <div className="size-9 rounded-__TMP__ bg-[image:var(--gradient-primary)] shadow-[var(--shadow-soft)] grid place-items-center text-white">
        ...
        <nav className="flex flex-col gap-1">
          {nav.map((n) => (
            <a
              key={n.label}
              href="#"
              className={`flex items-center gap-3 px-3 py-2.5 rounded-__TMP__ text-sm transition-all ${
                n.active
        ...
        <div className="mt-auto flex flex-col gap-2">
          <div className="rounded-__TMP__ p-4 bg-[image:var(--gradient-soft)] border border-border/60">
      ...
      <main className="flex-1 min-w-0 px-6 lg:px-10 py-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_340px] gap-6">
          <div className="flex flex-col gap-6 min-w-0">
            ...
            <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {taskBuckets.map((b) => (
                <div
                  key={b.label}
                  className="rounded-__TMP__ bg-card border border-border/60 p-5 shadow-[var(--shadow-card)] hover:-translate-y-0.5 hover:shadow-[var(--shadow-soft)] transition"
                >
            ...
            <section className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-6">
              <div className="rounded-__TMP__ bg-card border border-border/60 p-6 shadow-[var(--shadow-card)]">
                  ...
                  {barData.map((v, i) => (
                    <div key={i} className="flex-1 flex flex-col items-center gap-2">
                      <div className="relative w-full flex justify-center">
                        ...
                        <div
                          className={`w-7 rounded-__TMP__ transition-all ${
                            i === 3
              ...
              <div className="rounded-__TMP__ bg-card border border-border/60 p-6 shadow-[var(--shadow-card)]">
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div className="rounded-__TMP__ bg-muted/60 py-2">
            ...
            {/* Workload curve */}
            <section className="rounded-__TMP__ bg-card border border-border/60 p-6 shadow-[var(--shadow-card)]">
          ...
          <aside className="flex flex-col gap-6">
            <div className="rounded-__TMP__ p-6 bg-[image:var(--gradient-primary)] text-white shadow-[var(--shadow-soft)] relative overflow-hidden">
            ...
            <div className="rounded-__TMP__ bg-card border border-border/60 p-5 shadow-[var(--shadow-card)]">
              <div className="flex items-center justify-between mb-4">
              ...
              <ul className="flex flex-col gap-3">
                {todayTasks.map((t) => (
                  <li key={t.title} className="flex items-start gap-3 p-3 rounded-__TMP__ bg-muted/50 hover:bg-muted transition">
            ...
            <div className="rounded-__TMP__ bg-card border border-border/60 p-5 shadow-[var(--shadow-card)]">
              ...
              <ul className="flex flex-col gap-2">
                {[
                  ...
                  <li key={o.t} className="flex items-center gap-3 p-2.5 rounded-__TMP__ hover:bg-muted/60 transition">
                    <div className="size-8 rounded-__TMP__ bg-[oklch(0.94_0.07_20)] grid place-items-center text-[oklch(0.5_0.18_20)]">
